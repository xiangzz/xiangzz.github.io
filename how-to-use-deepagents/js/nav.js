  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      slides.forEach(function(slide, i) {
        ...
        item.addEventListener('click', function(e) {
          ...
          if (window.Presentation && typeof window.Presentation.showSlide === 'function') {
            ...
            document.dispatchEvent(new CustomEvent('slidechange', { detail: { index: i, total: slides.length } }));
    ...
    function injectSlideTOCStyles() {
      ...
      style.textContent = '\
        ...
        .global-nav-toggle { left: auto !important; right: 12px !important; top: 12px !important; }\
