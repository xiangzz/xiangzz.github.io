...
(function() {
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function injectSlideTOCStyles() {
      ...
      style.textContent = `
        .slide-toc { position: fixed; top: 0; left: 0; right: auto; bottom: 6px; width: 260px; background: rgba(255,255,255,0.96); border-right: 1px solid var(--border-color); box-shadow: 2px 0 10px rgba(0,0,0,0.06); z-index: 1000; display: flex; flex-direction: column; transform: translateX(0); transition: transform 0.3s ease; }
        ...
        @media (min-width: 1200px) { .slide { padding-left: 360px; } body.toc-closed .slide { padding-left: 100px; } .controls { left: 260px; } body.toc-closed .controls { left: 0; } .progress-bar-container { left: 260px; } body.toc-closed .progress-bar-container { left: 0; } }
        @media (max-width: 1200px) and (min-width: 900px) { .slide-toc { width: 220px; } .slide { padding-left: 240px; } body.toc-closed .slide { padding-left: 60px; } .controls { left: 220px; } body.toc-closed .controls { left: 0; } .progress-bar-container { left: 220px; } body.toc-closed .progress-bar-container { left: 0; } }
        @media (max-width: 900px) and (min-width: 641px) { .slide-toc { width: 180px; opacity: 0.96; } .slide { padding-left: 200px; } body.toc-closed .slide { padding-left: 40px; } .controls { left: 180px; } body.toc-closed .controls { left: 0; } .progress-bar-container { left: 180px; } body.toc-closed .progress-bar-container { left: 0; } }
        @media (max-width: 768px) and (min-width: 641px) { .slide-toc { width: 160px; } .slide-toc-header { padding: 10px 12px; } .slide-toc-title { font-size: 15px; } .slide-toc-item { padding: 8px 12px; gap: 10px; } .slide-toc-number { min-width: 24px; height: 24px; line-height: 24px; font-size: 11px; } .slide-toc-text { font-size: 13px; } .slide { padding-left: 180px; } body.toc-closed .slide { padding-left: 20px; } .controls { left: 160px; } body.toc-closed .controls { left: 0; } .progress-bar-container { left: 160px; } body.toc-closed .progress-bar-container { left: 0; } }
